...
def compute_f1(predictions, correct, idx2Label, correctBIOErrors='No', encodingScheme='BIO'):
    ...
    label_pred = []
    label_pred.append([idx2Label[int(element)] for element in predictions])
        
    label_correct = []    
    label_correct.append([idx2Label[element] for element in correct])
            ...
            if label.startswith('B'):
                ...
                if not labelStarted:
                    ...
                    if correctBIOErrors.upper() == 'B':
                        ...
                        predictions[sentenceIdx][labelIdx] = 'B'
                        labelStarted = True
                        # labelClass = label[2:]
